modded class X18_Electrogeist
{
	protected ref AreaDamageBase m_AreaDamage;
	protected X18_Electrogeist_Active m_Active;
	...
	{
		if (GetGame().IsDedicatedServer())
			m_Active = X18_Electrogeist_Active.Cast(GetGame().CreateObject("X18_Electrogeist_Active", this.GetPosition(), false));
	}
