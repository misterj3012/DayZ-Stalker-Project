class MediKitTier2Mdfr : ModifierBase
{
	...
	override void Init()
	{
		...
		m_ID = X18MedicalModifiers.MDF_MEDIKIT_TIER2;
		m_TickIntervalInactive = 1;
		m_TickIntervalActive = 1;
		m_IsPersistent = true;
		m_EffectLifetime = MedicalConfig.Tier2_MediKitDuration;
		m_IncreaseHealth = MedicalConfig.Tier2_MediKitHealth;
		m_IncreaseWater = MedicalConfig.Tier2_MediKitWater;
		m_IncreaseEnergy = MedicalConfig.Tier2_MediKitEnergy;
		m_IncreaseBlood = MedicalConfig.Tier2_MediKitBlood;
		m_DecreaseRadiation = MedicalConfig.Tier2_MediKitRadiation;
		m_RemoveCuts = MedicalConfig.Tier2_MediKitCuts;
	}
