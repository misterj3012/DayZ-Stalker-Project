class AntiRadVodkaMdfr : ModifierBase
{
	...
	override void Init()
	{
		...
		m_ID = X18MedicalModifiers.MDF_ANTIRADVODKA;
		m_TickIntervalInactive = 1;
		m_TickIntervalActive = 1;
		m_IsPersistent = true;
		m_EffectLifetime = MedicalConfig.DecreaseRadiationByVodkaDuration;
		m_DecreaseRadiation = MedicalConfig.DecreaseRadiationByVodka;
	}
