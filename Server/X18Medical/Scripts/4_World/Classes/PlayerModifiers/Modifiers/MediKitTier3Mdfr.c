class MediKitTier3Mdfr : ModifierBase
{
	...
	override void Init()
	{
		...
		m_ID = X18MedicalModifiers.MDF_MEDIKIT_TIER3;
		m_TickIntervalInactive = 1;
		m_TickIntervalActive = 1;
		m_IsPersistent = true;
		m_EffectLifetime = MedicalConfig.Tier3_MediKitDuration;
		m_IncreaseHealth = MedicalConfig.Tier3_MediKitHealth;
		m_IncreaseWater = MedicalConfig.Tier3_MediKitWater;
		m_IncreaseEnergy = MedicalConfig.Tier3_MediKitEnergy;
		m_IncreaseBlood = MedicalConfig.Tier3_MediKitBlood;
		m_DecreaseRadiation = MedicalConfig.Tier3_MediKitRadiation;
		m_RemoveCuts = MedicalConfig.Tier3_MediKitCuts;
	}
