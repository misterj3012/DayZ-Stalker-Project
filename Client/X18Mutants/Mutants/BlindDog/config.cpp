class CfgPatches
{
	class X18Mutants_Animals_BlindDog
	{
		units[] = { "Mutant_AoD_Dog_Red","Mutant_AoD_Dog_White","Mutant_AoD_Dog_Fur","Mutant_AoD_Dog_Brown" };
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = { "DZ_Animals","DZ_Weapons_Melee", "DZ_AoD_Mutant_Sleep_Dog", "DZ_AoD_Mutant_Dog_Tail" };
		ammo[] = { "MeleeDog","MeleeDog_Hight" };
	};
};
class GroupBehaviourTemplates
{
	class DZBlindDogGroupBeh
	{
		type = "Predators";
...
{
	class Predators_BlindDog
	{
		HeadLookBoneName = "pin_lookat";
		teamName = "Predator";
		defaultGroupTemplateName = "DZBlindDogGroupBeh";
		class PathAgent
		{
			radius = 0.3;
			height = 1;
...
class CfgVehicles
{
	...
	class X18_Mutant_Animal_BlindDog_Red : Mutant_AoD_Dog_Red
	{
		scope = 2;
		displayName = "$STR_BlindDog";
		descriptionShort = "$STR_DSC_BlindDog";
		aiAgentTemplate = "Predators_BlindDog";
		DamageSphereAmmos[] = { "MeleeBlindDog" };
		...
		class Skinning
		{
			class ObtainedTail
			{
				item = "X18_Loot_Mutant_Animal_BlindDog_Tail";
				count = 1;
			};
			class ObtainedSteaks
			{
				item = "X18_Loot_Mutant_Animal_BlindDog_SteakMeat";
				count = 3;
		...
		class AnimEvents
		{
			...
			class Sounds
			{
				...
				class WolfGroans
				{
					soundSet = "BDogGroan_SoundSet";
					noise = "WolfRoarNoise";
					id = 5;
				};
				class WolfGrowl_A
				{
					soundSet = "BDogGrowl_SoundSet";
					noise = "WolfRoarNoise";
					id = 6;
				};
				class WolfGrowl_B
			...
			class Damages
			{
				class Bite
				{
					damage = "BlindDogBiteDamage";
					id = 1;
				};
				class BiteLow
				{
					damage = "BlindDogLowBiteDamage";
					id = 2;
				};
			};
		};
	...
	class X18_Mutant_Animal_BlindDog_White : Mutant_AoD_Dog_White
	{
		scope = 2;
		displayName = "$STR_BlindDog";
		descriptionShort = "$STR_DSC_BlindDog";
	...
	class X18_Mutant_Animal_BlindDog_Fur : Mutant_AoD_Dog_Fur
	{
		scope = 2;
		displayName = "$STR_BlindDog";
		descriptionShort = "$STR_DSC_BlindDog";
	...
	class X18_Mutant_Animal_BlindDog_Brown : Mutant_AoD_Dog_Brown
	{
		scope = 2;
		displayName = "$STR_BlindDog";
		descriptionShort = "$STR_DSC_BlindDog";
	...
	class Mutant_AoD_Dog_Tail;
	class X18_Loot_Mutant_Animal_BlindDog_Tail : Mutant_AoD_Dog_Tail
	{
		scope = 2;
		displayName = "$STR_BlindDog_Tail";
		descriptionShort = "$STR_DSC_BlindDog_Tail";
		weight = 600;
		itemSize[] = { 2,2 };
		varQuantityInit = 0;
		varQuantityMin = 0;
