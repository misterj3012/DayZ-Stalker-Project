class CfgPatches
{
	class X18Mutants_Animals_Boar
	{
		units[] = { "Mutant_AoD_Boar1","Mutant_AoD_Boar2","Mutant_AoD_Boar1_Easy","Mutant_AoD_Boar2_Easy" };
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = { "DZ_Animals", "DZ_Weapons_Melee", "DZ_AI", "DZ_AoD_Mutant_Boar", "DZ_AoD_Mutant_Boar_Leg" };
		ammo[] = { "MeleeBoar","MeleeBoar_Hight" };
	};
};
class GroupBehaviourTemplates
{
	class DZBoarGroupBeh
	{
		type = "Predators";
...
{
	class Predators_Boar
	{
		HeadLookBoneName = "pin_lookat";
		teamName = "Predator";
		defaultGroupTemplateName = "DZBoarGroupBeh";
		class PathAgent
		{
			radius = 0.3;
			height = 1;
...
class CfgVehicles
{
	class Mutant_AoD_Boar1;
	class Mutant_AoD_Boar2;
	class X18_Mutant_Animal_Boar : Mutant_AoD_Boar1
	{
		scope = 2;
		displayName = "$STR_Boar";
		descriptionShort = "$STR_DSC_Boar";
		aiAgentTemplate = "Predators_Boar";
		DamageSphereAmmos[] = { "MeleeBoar" };
		...
		class Skinning
		{
			class ObtainedLeg
			{
				item = "X18_Loot_Mutant_Animal_Boar_Leg";
				count = 1;
			};
			class ObtainedSteaks
			{
				item = "X18_Loot_Mutant_Animal_Boar_SteakMeat";
				count = 3;
		...
		class AnimEvents
		{
			...
			class Sounds
			{
				...
				class WolfGroans
				{
					soundSet = "BoarGroan_SoundSet";
					noise = "WolfRoarNoise";
					id = 5;
				};
				class WolfGrowl_A
				{
					soundSet = "BoarGrowl_SoundSet";
					noise = "WolfRoarNoise";
					id = 6;
				};
				class WolfGrowl_B
				...
				class WolfPant
				{
					soundSet = "BoarPain_SoundSet";
					noise = "WolfRoarNoise";
					id = 9;
				};
				class WolfPantShort
				{
					soundSet = "BoarIdle_SoundSet";
					noise = "WolfRoarNoise";
					id = 10;
				};
				class WolfPantLong
				...
				class WolfWhimper
				{
					soundSet = "BoarHowl_SoundSet";
					noise = "WolfRoarNoise";
					id = 13;
				};
				class WolfYelp
				{
					soundSet = "BoarDie_SoundSet";
					noise = "WolfRoarNoise";
					id = 14;
				};
				class WolfYawn
			...
			class Damages
			{
				class Bite
				{
					damage = "BoarBiteDamage";
					id = 1;
				};
				class BiteLow
				{
					damage = "BoarLowBiteDamage";
					id = 2;
				};
			};
		};
	...
	class X18_Mutant_Animal_Boar_Black : Mutant_AoD_Boar2
	{
		scope = 2;
		displayName = "$STR_Boar";
		descriptionShort = "$STR_DSC_Boar";
	...
	class Mutant_AoD_Boar_Leg : Inventory_Base {};
	class X18_Loot_Mutant_Animal_Boar_Leg : Mutant_AoD_Boar_Leg
	{
		scope = 2;
		displayName = "$STR_AoD_Mutant_Boar_Leg_Name";
		descriptionShort = "$STR_AoD_Mutant_Boar_Leg_Decr";
		weight = 800;
		itemSize[] = { 2,2 };
		varQuantityInit = 0;
		varQuantityMin = 0;
