class CfgPatches
{
	class X18Mutants_PsyDog
	{
		...
		ammo[] = { "MeleePsyDog","MeleePsyDog_Hight" };
	};
};
class GroupBehaviourTemplates
{
	class DZPsyDogGroupBeh
	{
		type = "Predators";
...
{
	class Predators_PsyDog
	{
		HeadLookBoneName = "pin_lookat";
		teamName = "Predator";
		defaultGroupTemplateName = "DZPsyDogGroupBeh";
		class PathAgent
		{
			radius = 0.3;
			height = 1;
...
class CfgVehicles
{
	...
	class X18_Mutant_Animal_PsyDog : Mutant_AoD_Pse_Dog1
	{
		scope = 2;
		displayName = "$STR_PsyDog";
		descriptionShort = "$STR_DSC_PsyDog";
		aiAgentTemplate = "Predators_PsyDog";
		DamageSphereAmmos[] = { "MeleePsyDog" };
		...
		class Skinning
		{
			class ObtainedHead
			{
				item = "X18_Loot_Mutant_Animal_PsyDog_Head";
				count = 1;
			};
			class ObtainedTail
			{
				item = "X18_Loot_Mutant_Animal_PsyDog_Tail";
				count = 1;
			};
			class ObtainedSteaks
			{
				item = "X18_Loot_Mutant_Animal_PsyDog_SteakMeat";
				count = 2;
		...
		class AnimEvents
		{
			...
			class Damages
			{
				class Bite
				{
					damage = "PsyDogBiteDamage";
					id = 1;
				};
				class BiteLow
				{
					damage = "PsyDogLowBiteDamage";
					id = 2;
				};
			};
		};
	...
	class X18_Mutant_Animal_PsyDog_Phantom : Mutant_AoD_Pse_Dog2
	{
		scope = 2;
		displayName = "$STR_PsyDog";
		descriptionShort = "$STR_DSC_PsyDog";
		aiAgentTemplate = "Predators_PsyDog";
		DamageSphereAmmos[] = { "MeleePsyDogPhantom" };
		injuryLevels[] = { 1.0,0.5,0.2,0.0 };
		class DamageSystem
		{
			class GlobalHealth
		...
		class AnimEvents
		{
			...
			class Damages
			{
				class Bite
				{
					damage = "PsyDogPhantomBiteDamage";
					id = 1;
				};
				class BiteLow
				{
					damage = "PsyDogPhantomLowBiteDamage";
					id = 2;
				};
			};
		};
	...
	class X18_Loot_Mutant_Animal_PsyDog_Head : FS_PseDog_Head
	{
		scope = 2;
		displayName = "$STR_PsyDog_Head";
		descriptionShort = "$STR_DSC_PsyDog_Head";
		weight = 1300;
		itemSize[] = { 3,4 };
		varQuantityInit = 0;
		varQuantityMin = 0;
	...
	class X18_Loot_Mutant_Animal_PsyDog_Tail : Mutant_AoD_Pdog_Tail
	{
		scope = 2;
		displayName = "$STR_PsyDog_Tail";
		descriptionShort = "$STR_DSC_PsyDog_Tail";
		weight = 400;
		itemSize[] = { 2,2 };
		varQuantityInit = 0;
		varQuantityMin = 0;
	...
	class PhantomSpawnFX : HouseNoDestruct
	{
		scope = 2;
		weight = 99999999;
	};
	class PhantomDespawnFX : HouseNoDestruct
	{
		scope = 2;
		weight = 99999999;
	};
...
class CfgSounds
{
	...
	class phantom_spawn_sound : default
	{
		sound[] = { "\Noosphere\X18Mutants\Mutants\PsyDog\Data\PsyDog_Spawn", 2, 1, 30 };
	};
};