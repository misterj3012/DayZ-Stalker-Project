class CfgPatches
{
	class X18Mutants_Animals_Flesh
	{
		units[] = { "Mutant_AoD_Fresh1","Mutant_AoD_Fresh2","Mutant_AoD_Fresh3","Mutant_AoD_Fresh1_Easy","Mutant_AoD_Fresh2_Easy","Mutant_AoD_Fresh3_Easy" };
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = { "DZ_Animals", "DZ_Weapons_Melee","DZ_AoD_Mutant_Fresh","DZ_AoD_Mutant_Fresh_Eye" };
		ammo[] = { "MeleeFlesh","MeleeFlesh_Hight" };
	};
};
class GroupBehaviourTemplates
{
	class DZFleshGroupBeh
	{
		type = "Predators";
...
{
	class Predators_Flesh
	{
		HeadLookBoneName = "pin_lookat";
		teamName = "Predator";
		defaultGroupTemplateName = "DZFleshGroupBeh";
		class PathAgent
		{
			radius = 0.3;
			height = 1;
...
class CfgVehicles
{
	class Mutant_AoD_Fresh1;
	class Mutant_AoD_Fresh2;
	class Mutant_AoD_Fresh3;
	class X18_Mutant_Animal_Flesh : Mutant_AoD_Fresh1
	{
		scope = 2;
		displayName = "$STR_AoD_Mutant_Fresh_Name";
		aiAgentTemplate = "Predators_Flesh";
		DamageSphereAmmos[] = { "MeleeFlesh" };
		...
		class Skinning
		{
			class ObtainedEye
			{
				item = "X18_Loot_Mutant_Animal_Flesh_Eye";
				count = 1;
			};
			class ObtainedSteaks
			{
				item = "X18_Loot_Mutant_Animal_Flesh_SteakMeat";
				count = 2;
		...
		class AnimEvents
		{
			...
			class Sounds
			{
				...
				class WolfBark2
				{
					soundSet = "FreshAttack2_SoundSet";
					noise = "WolfRoarNoise";
					id = 2;
				};
				class WolfBark3
				...
				class WolfGroans
				{
					soundSet = "FreshGroan_SoundSet";
					noise = "WolfRoarNoise";
					id = 5;
				};
				class WolfGrowl_A
				{
					soundSet = "FreshGrowl_SoundSet";
					noise = "WolfRoarNoise";
					id = 6;
				};
				class WolfGrowl_B
				...
				class WolfDeath
				{
					soundSet = "FreshHurt_SoundSet";
					noise = "WolfRoarNoise";
					id = 20;
				};
				class WolfHowl
				{
					soundSet = "FreshHowl_SoundSet";
					noise = "WolfRoarNoise";
					id = 16;
				};
				class WolfHowls
				{
					soundSet = "FreshDistant_SoundSet";
					noise = "WolfRoarNoise";
					id = 17;
				};
			};
			class Damages
			{
				class Bite
				{
					damage = "FleshBiteDamage";
					id = 1;
				};
				class BiteLLow
				{
					damage = "FleshLowBiteLDamage";
					id = 2;
				};
				class BiteRLow
				{
					damage = "FleshLowBiteRDamage";
					id = 3;
				};
			};
		};
	...
	class X18_Mutant_Animal_Flesh_2 : Mutant_AoD_Fresh2
	{
		scope = 2;
		displayName = "$STR_AoD_Mutant_Fresh_Name";
		aiAgentTemplate = "Predators_Flesh";
	...
	class X18_Mutant_Animal_Flesh_3 : Mutant_AoD_Fresh3
	{
		scope = 2;
		displayName = "$STR_AoD_Mutant_Fresh_Name";
		aiAgentTemplate = "Predators_Flesh";
	...
	class Mutant_AoD_Fresh_Eye : Inventory_Base {};
	class X18_Loot_Mutant_Animal_Flesh_Eye : Mutant_AoD_Fresh_Eye
	{
		scope = 2;
		displayName = "$STR_AoD_Mutant_Fresh_Eye_Name";
		descriptionShort = "$STR_AoD_Mutant_Fresh_Eye_Decr";
		weight = 200;
		itemSize[] = { 1,1 };
		varQuantityInit = 0;
		varQuantityMin = 0;
